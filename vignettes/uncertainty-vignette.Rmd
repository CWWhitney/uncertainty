...
If we want to tell the difference in two distributions determined by the `varkernelslice()` ranges we can test the difference. We can extract the data with the `varkernelslice_data()` function.
